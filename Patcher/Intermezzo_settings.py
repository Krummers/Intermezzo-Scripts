    ...
    while True:
        ...
        match setting:
            ...
            case "B":
                ...
                ft.clear_screen()
            case "C":
                cfg = fl.CFG(os.path.join(settings.path, "gesso.cfg"))
                print("The current value is:", cfg.get_value())
                print("This option adds a Feather model to the patch2.tar.")
                
                for x in range(len(cs.gesso)):
                    print(chr(x + 65), ". ", cs.gesso[x], sep = "")
                ...
                while True:
                    ...
                    elif gesso.isalpha() and ord(gesso.upper()) - 65 in range(len(cs.gesso)):
                        gesso = ord(gesso.upper()) - 65
                        break
                    else:
                        print("This is not an option. Please try again.")
                
                cfg.set_value(cs.gesso[gesso])
                ft.clear_screen()
            case "D":
                ...
                ft.clear_screen()
            case "E":
                cfg = fl.CFG(os.path.join(settings.path, "kumo.cfg"))
                print("The current value is:", cfg.get_value())
                print("This option adds a Thunder Cloud model to the patch2.tar.")
                
                for x in range(len(cs.kumo)):
                    print(chr(x + 65), ". ", cs.kumo[x], sep = "")
                ...
                while True:
                    ...
                    if len(kumo) != 1:
                        print("This is not an option. Please try again.")
                    elif kumo.isalpha() and ord(kumo.upper()) - 65 in range(len(cs.kumo)):
                        kumo = ord(kumo.upper()) - 65
                        break
                    else:
                        print("This is not an option. Please try again.")
                
                cfg.set_value(cs.kumo[kumo])
                ft.clear_screen()
            case "F":
